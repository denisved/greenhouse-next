  ...
  return (
    <div className="p-5 max-w-screen-xl mx-auto">
      ...
      <div className="text-lg text-gray-800 dark:text-gray-200 mb-8 text-left">
        <p className="mb-4">
          This page allows you to connect to the MQTT broker. Enter your login credentials below to 
          establish a connection. Once connected, you will be able to publish and subscribe to topics 
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center p-5 max-w-screen-sm mx-auto">
        <div className="grid gap-6 mb-6 w-full">
          <div>
            ...
            <input
              type="text"
              id="login"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500
        ...
        <div className="flex gap-4 w-full justify-center">
          <button type="submit" className="transition-transform duration-300 ease-in-out transform hover:scale-105 text-white
           bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full 
           text-lg w-full sm:w-auto px-8 py-4 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
          ...
          {isConnected && (
            <button
              ...
              className="transition-transform duration-300 ease-in-out transform hover:scale-105 text-white bg-red-600
               hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-lg w-full
                sm:w-auto px-8 py-4 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            >
              Disconnect
            </button>
          )}
